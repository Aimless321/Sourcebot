...
import {chatGPTApiKey} from '../../config.json';
...
/**
 * Utility function to call OpenAI Chat Completion with additional parameters
 * to generate comedic, varied text.
 */
async function generateChatCompletion(systemContent: string, userContent: string) {
